  ...
  return (
    <div className="flex shrink-0 flex-col" style={{ width }}>
      <button
        ...
        className="flex items-center gap-1.5 border-b border-border px-3 py-2 text-left text-xs font-medium text-muted-foreground hover:bg-accent disabled:opacity-40"
      >
        <Plus size={13} />
        Add page
      </button>
